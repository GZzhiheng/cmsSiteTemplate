...
(function () {
  ...
  window.UEDITOR_CONFIG = {
    ...
    //图片上传配置区
    , imageUrl: (window.host || '') + "/cms/rest/common/upload.do"            //图片上传提交地址
    , imageUrlPrefix: ''
    , imageMaxSize: 1024 * 1024 * 2
    , imageAllowFiles: ['gif,png,jpg,jpeg']
    , imageActionName: ( window.host || '') + "/cms/rest/common/upload.do"
    ...
    , toolbars: [[
      ...
      'insertimage', 'insertvideo', 'pagebreak', '|',
